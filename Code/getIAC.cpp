...
Mat getCalibrationMatrix(Point3_<double> v, Point3_<double> v1, Point3_<double> v2, Mat H) {
	/**
	...
	std::cout << "*vertical vp = " << std::endl << " " << v << std::endl << std::endl;
	std::cout << "*1st horizontal vp = " << std::endl << " " << v1 << std::endl << std::endl;
	std::cout << "*2nd horizontal vp = " << std::endl << " " << v2 << std::endl << std::endl;
	...
	double a[] = {	
			...
			v.x * v1.x, v.x * v1.z + v.z * v1.x, v.y * v1.z + v.z * v1.y, v.z * v1.z,

			// Equation 2 : a*v(1)*v1(1) + b*v(1)*v1(3) + v(2)*v1(2) + c*v(2)*v1(3) + b*v(3)*v1(1) + c*v(3)*v1(2) + d*v(3)*v1(3);
			v.x * v2.x, v.x * v2.z + v.z * v2.x, v.y * v2.z + v.z * v2.y, v.z * v2.z,
